...
- [ ] Identify opportunities for deep modules (small interface, deep implementation) — run the `dmi-superpowers:codebase-design` skill for the vocabulary and the testability checks
