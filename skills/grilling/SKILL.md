---
name: grilling
description: Use when the user wants to stress-test a plan or design before building, or says grill. For a grilling session that should also write ADRs and update the glossary, use grill-with-docs instead.
---
