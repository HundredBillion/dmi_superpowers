...
Upstream commit: https://github.com/HundredBillion/dmi_superpowers/commit/$UPSTREAM_SHA
...
Upstream: https://github.com/HundredBillion/dmi_superpowers/commit/$UPSTREAM_SHA
Branch:   $SYNC_BRANCH"
